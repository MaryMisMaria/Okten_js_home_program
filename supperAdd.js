...
//      user.innerText = `${item.address.city} ${item.address.country} ${item.address.street} ${item.address.houseNumber}`;
...
//4- За допомоги циклу проітерувати  масив users, записати кожного юзера в сівй блок за допомоги document.createElement,
...
for(let item of users){
    ...
    houseNumber.innerText='hoseNumber -' + item.address.houseNumber;
