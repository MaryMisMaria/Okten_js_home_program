...
for (let item of usersList) {
   ...
   geo.innerText=`${item.address.geo}`;
   ...
   geo.appendChild(lat);
   geo.appendChild(lng);
    elemMain.appendChild(website);
    elemMain.appendChild(phone);
    address.appendChild(street);
    address.appendChild(suite);
    address.appendChild(city);
    address.appendChild(zipcode);
    address.appendChild(geo);
    elemMain.appendChild(address);
    elemMain.appendChild(idElement);
    elemMain.appendChild(usernameDiv);
    elemMain.appendChild(nameDiv);
    elemMain.appendChild(emailDiv);
