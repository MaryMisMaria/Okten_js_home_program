...
for( let item of simpsons){
    document.write(`Name - ${item.name} Surname - ${item.surname} Age- ${item.age} INFO- ${item.info} <img src="${item.photo}" alt="" `);
}
...
for( let item of simpsons){
   ...
   document.write(` <img src="${item.photo}" alt="picture">`);
}
document.write('</div>');
// <!--        template 3.1-->
//         <div>
...
for(let items of products){
    document.write('<div display="flex" width="300px" height="300px   class="product-card">');
    document.write('<h3  text-align="center" class="product-title" >') ;
    document.write(`${items.title}. Price- ${items.price}`);
    document.write(`<img src="${items.image}" alt="picture" width="200px"  height="200px" class="product-image">`)
    document.write('</h3>');
    document.write('</div>');
}
document.write('</div>');
